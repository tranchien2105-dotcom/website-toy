        ...
        <div class="container">
            <header>
                <div class="row">
                    ...
                    <!-- Logo -->
                    <div class="col-xs-2">
                        <div class="logo"> <a href="index.html"><img src="images/logo-6.png" alt=""></a> </div>
                    </div>
                    <div class="col-xs-5">
                        <!-- Cart Part -->
                        <ul class="nav navbar-right cart-pop">
                            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                    role="button" aria-haspopup="true" aria-expanded="false"><span
                                        class="itm-cont">3</span> <i class="flaticon-shopping-bag"></i> <strong>My
                                        Cart</strong> <br>
                                    <span>3 item(s) - $500.00</span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="media-left"> <a href="#." class="thumb"> <img
                                                    src="images/item-img-1-1.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="media-body"> <a href="#." class="tittle">Funda Para Ebook 7" 128GB
                                                full HD</a> <span>250 x 1</span> </div>
                                    </li>
                                    <li>
                                        <div class="media-left"> <a href="#." class="thumb"> <img
                                                    src="images/item-img-1-2.jpg" class="img-responsive" alt=""> </a>
                                        </div>
                                        <div class="media-body"> <a href="#." class="tittle">Funda Para Ebook 7" full
                ...
                <nav class="navbar ownmenu">
                    ...
                    <!-- Categories -->
                    <div class="cate-lst"> <a data-toggle="collapse" class="cate-style" href="#."><i
                                class="fa fa-list-ul"></i> Our Categories </a> </div>
                            ...
                            <li class="dropdown megamenu active"> <a href="index.html" class="dropdown-toggle"
                                ...
                                <div class="dropdown-menu animated-2s fadeInUpHalf">
                                    <div class="mega-inside scrn">
                                        <ul class="home-links">
                                            <li><a href="index.html"><img class="img-responsive" src="images/home-1.jpg"
                                                        alt=""> <span>Home Version 1</span></a></li>
                                            <li><a href="index-2.html"><img class="img-responsive"
                                                        src="images/home-2.jpg" alt=""> <span>Home Version 2</span></a>
                                            </li>
                                            <li><a href="index-3.html"><img class="img-responsive"
                                                        src="images/home-3.jpg" alt=""> <span>Home Version 3</span></a>
                                            </li>
                                            <li><a href="index-4.html"><img class="img-responsive"
                                                        src="images/home-4.jpg" alt=""> <span>Home Version 4</span></a>
                                            </li>
                                            <li><a href="index-5.html"><img class="img-responsive"
                                                        src="images/home-5.jpg" alt=""> <span>Home Version 5</span></a>
                                            </li>
                                            <li><a href="index-6.html"><img class="img-responsive"
                                                        src="images/home-6.jpg" alt=""> <span>Home Version 6</span></a>
                                            </li>
                                            <li><a href="index-7.html"><img class="img-responsive"
                                                        src="images/home-7.jpg" alt=""> <span>Home Version 7</span></a>
                                            </li>
                                            <li><a href="index-8.html"><img class="img-responsive"
                                                        src="images/home-8.jpg" alt=""> <span>Home Version 8</span></a>
                                            </li>
                                            <li><a href="index-9.html"><img class="img-responsive"
                                                        src="images/home-9.jpg" alt=""> <span>Home Version 9</span></a>
                                            </li>
                                            <li><a href="index-10.html"><img class="img-responsive"
                                                        src="images/home-10.jpg" alt=""> <span>Home Version
                                                        10</span></a></li>
                                            <li><a href="index-11.html"><img class="img-responsive"
                                                        src="images/home-11.jpg" alt=""> <span>Home Version
                                                        11</span></a></li>
                                            <li><a href="index-12.html"><img class="img-responsive"
                                                        src="images/home-12.jpg" alt=""> <span>Home Version
                                                        12</span></a></li>
                                            <li><a href="index-13.html"><img class="img-responsive"
                                                        src="images/home-13.jpg" alt=""> <span>Home Version
                                                        13</span></a></li>
                                            <li><a href="index-14.html"><img class="img-responsive"
                                                        src="images/home-14.jpg" alt=""> <span>Home Version
                                                        14</span></a></li>
                                            <li><a href="index-15.html"><img class="img-responsive"
                                                        src="images/home-15.jpg" alt=""> <span>Home Version
                                                        15</span></a></li>
                                            <li><a href="index-16.html"><img class="img-responsive"
                                                        src="images/home-16.jpg" alt=""> <span>Home Version
                                                        16</span></a></li>
                                            <li><a href="index-17.html"><img class="img-responsive"
                                                        src="images/home-17.jpg" alt=""> <span>Home Version
                                                        17</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <!-- NAV RIGHT -->
                    <div class="nav-right padding-right-20"> <span class="call-mun"><i class="fa fa-phone"></i>
                            <strong>Hotline:</strong> (+100) 123 456 7890</span> </div>
                </nav>
            </header>
        </div>
                                ...
                                <div class="tp-banner with-bg-slide-all">
                                    <ul>
                                        ...
                                        <li data-transition="random" data-slotamount="7" data-masterspeed="300"
                                            ...
                                            <!-- MAIN IMAGE -->
                                            <img src="images/trans-bg.png" alt="slider" data-bgposition="center bottom"
                                                data-bgfit="cover" data-bgrepeat="no-repeat">

                                            <!-- LAYER NR. 1 -->
                                            <div class="tp-caption sfl tp-resizeme" data-x="left" data-hoffset="100"
                                                ...
                                                Collaborate in style! </div>

                                            <!-- LAYER NR. 2 -->
                                            <div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="100"
                                                data-y="center" data-voffset="-40" data-speed="800" data-start="1000"
                                                data-easing="Power3.easeInOut" data-splitin="chars" data-splitout="none"
                                                data-elementdelay="0.03" data-endelementdelay="0.1" data-endspeed="300"
                                                style="z-index: 6; font-size:36px; color:#27bdb1; font-weight:800; white-space: nowrap;">
                                                SmartPhone 6s </div>

                                            <!-- LAYER NR. 1 -->
                                            <div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="100"
                                                data-y="center" data-voffset="10" data-speed="800" data-start="1300"
                                                data-easing="Power3.easeInOut" data-splitin="chars" data-splitout="none"
                                                data-elementdelay="0.03" data-endelementdelay="0.4" data-endspeed="300"
                                                style="z-index: 5; font-size:36px; font-weight:800; color:#000;  max-width: auto; max-height: auto; white-space: nowrap;">
                                                $580.00 </div>
                                            <!-- LAYER NR. 1 -->
                                            <div class="tp-caption sfr tp-resizeme" data-x="right" data-hoffset="-100"
                                                data-y="center" data-voffset="0" data-speed="800" data-start="1300"
                                                data-easing="Power3.easeInOut" data-elementdelay="0.1"
                                                data-endelementdelay="0.1" data-endspeed="300" data-scrolloffset="0"
                                                style="z-index: 9;"><img src="images/slide-item-6-1.png" alt=""> </div>

                                            <!-- LAYER NR. 4 -->
                                            <div class="tp-caption lfb tp-resizeme" data-x="left" data-hoffset="100"
                                                data-y="center" data-voffset="100" data-speed="800" data-start="1300"
                                                data-easing="Power3.easeInOut" data-elementdelay="0.1"
                                                data-endelementdelay="0.1" data-endspeed="300" data-scrolloffset="0"
                                                style="z-index: 8;"><a href="#." class="btn-round big">Shop Now</a>
                                            </div>
                                        </li>
                                        ...
                                        <li data-transition="random" data-slotamount="7" data-masterspeed="300"
                                            ...
                                            <div class="tp-caption sfr tp-resizeme" data-x="left" data-hoffset="100"
                                                ...
                                                $250.00 </div>
                                            <!-- LAYER NR. 1 -->
                                            <div class="tp-caption sfr tp-resizeme" data-x="right" data-hoffset="-50"
                                                data-y="center" data-voffset="0" data-speed="800" data-start="1300"
                                                data-easing="Power3.easeInOut" data-elementdelay="0.1"
                                                data-endelementdelay="0.1" data-endspeed="300" data-scrolloffset="0"
                                                style="z-index: 9;"><img src="images/slide-item-6-2.png" alt=""> </div>
                                        ...
                                        <li data-transition="random" data-slotamount="7" data-masterspeed="300"
                                            ...
                                            <div class="tp-caption sfl tp-resizeme" data-x="left" data-hoffset="100"
                                                ...
                                                data-elementdelay="0.03" data-endelementdelay="0.4" data-endspeed="300"
                                                style="z-index: 5; font-size:24px; font-weight:500; color:#888888;  max-width: auto; max-height: auto; white-space: nowrap;">
                                                Get Free Gear 360 when buy </div>
                                            ...
                                            <div class="tp-caption sfr tp-resizeme" data-x="right" data-hoffset="-50"
                                                ...
                                                data-easing="Power3.easeInOut" data-elementdelay="0.1"
                                                data-endelementdelay="0.1" data-endspeed="300" data-scrolloffset="0"
                                                style="z-index: 9;"><img src="images/slide-item-6-3.png" alt=""> </div>
        ...
        <div id="content">
            ...
            <section class="featur-tabs padding-top-20 padding-bottom-60">
                <div class="container">
                    ...
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs nav-pills text-center margin-bottom-40" role="tablist">
                            ...
                            <div class="item-slide-4 with-nav middle-nav">
                                ...
                                <div class="product">
                                    <article> <img class="img-responsive" src="images/item-img-1-5.jpg" alt="">
                                        <!-- Content -->
                                        <span class="tag">Appliances</span> <a href="#." class="tittle">Mp3 Sumergible
                                            Deportivo Slim Con 8GB</a>
                                        <!-- Reviews -->
                                        <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                class="fa fa-star"></i><i class="fa fa-star"></i> <i
                            ...
                            <div class="item-col-4">
                                ...
                                <div class="product">
                                    <article> <img class="img-responsive" src="images/item-img-1-1.jpg" alt=""> <span
                                        ...
                                        <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                                class="fa fa-star"></i><i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <span class="margin-left-10">5 Review(s)</span>
                                        </p>
                                        <div class="price">$350.00 <span>$200.00</span></div>
                                        <a href="#." class="cart-btn"><i class="icon-basket-loaded"></i></a>
                                    </article>
            ...
            <!-- Top Selling Week -->
            <section class="padding-bottom-30 padding-top-60">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="product">
                                <article> <span class="sale-tag">-75%</span>
                                    <!-- Slider Thumb -->
                                    <div class="thumb-slider">
                                        <ul class="slides">
                                            <li data-thumb="images/item-img-1-6.jpg"> <img src="images/item-img-1-6.jpg"
                                                    alt=""> </li>
                                            <li data-thumb="images/item-img-1-7.jpg"> <img src="images/item-img-1-7.jpg"
                                                    alt=""> </li>
                                            <li data-thumb="images/item-img-1-15.jpg"> <img
                                                    src="images/item-img-1-15.jpg" alt=""> </li>
                                            <li data-thumb="images/item-img-1-2.jpg"> <img src="images/item-img-1-2.jpg"
                                                    alt=""> </li>
                                        </ul>
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="item-col-4">
                        ...
                        <div class="product">
                            <article> <img class="img-responsive" src="images/item-img-1-4.jpg" alt="">
                                <!-- Content -->
                                <span class="tag">Appliances</span> <a href="#." class="tittle">Funda Para Inalambrico
                                    Ebook 7" 128GB full HD</a>
                                <!-- Reviews -->
                                <p class="rev"><i class="fa fa-star"></i><i class="fa fa-star"></i><i
                                        class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star"></i>
                                    <span class="margin-left-10">5 Review(s)</span></p>
            ...
            <div class="newslatter newslatter-ie">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <h3> <i class="fa fa-envelope-o"></i> Subscribe our Newsletter <small>Get 25% Off first
                                    purchase!</small></h3>
                        </div>
                        <div class="col-md-5">
                            <form>
                        ...
                        <div class="col-md-3">
                            <h3> <i class="fa fa-phone"></i> (+100) 123 456 7890 <small>Call us toll Free 24/7!</small>
                            </h3>
                        </div>
                    </div>
                </div>
        ...
        <footer>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <h4>Custom Block</h4>
                        <img src="images/footer-add.jpg" alt="">
                    </div>
                </div>
            </div>
        </footer>
